...
Once a delivery group is created you can proceed with eventually adding a routing order followed by a customer order with packages and eventually a sender in the same request.
