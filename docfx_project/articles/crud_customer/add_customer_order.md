...
A customer can be added independently or as part of an existing [order](/articles/crud_order/get_order.html). If not specified, it will be added to the inbox. Use order_id if you want to specify which order it should be connected to
...
|language_code|string or null||sv_SE|
...
|packages_replace|boolean or null|||
...
|vehicle_tags|string or null|Tags used for pairing delivery with specific vehicle(s)||
...
|url|string or null|A url linking to a page with information about the package, e.g. a product image|https://cloud.pindeliver.com/img/pinDeliver_logo_red.png	|
...
|Property              |Type     |Description          |Example      |  
|----------------------|---------|---------------------|-------------|
|adr_points|integer or null||198|
|un_number|string or null||3262|
|marine_pollutant|boolean or null||true|
|article_number|string or null||002469|
|flash_point|integer or null||70|
